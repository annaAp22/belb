		...
		<button class="btn btn_carousel-control">
			...
			<div class="products-carousel__wrap">
				<div class="products-carousel__track">
					<?php $__currentLoopData = $product->restKit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

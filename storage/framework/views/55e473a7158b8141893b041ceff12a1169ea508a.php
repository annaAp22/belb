                ...
                <div class="tabbable">
                        ...
                        <div class="table-header">
                            ...
                            <div class="ibox-tools">
                                <a href="<?php echo e(route('admin.offers.create')); ?>" class="btn btn-success btn-xs">
                    ...
                    <div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
                        ...
                        <div class="row">
                            ...
                            <!-- FILTERS -->
                            <div class="row">
                                <form method="GET" action="<?php echo e(route('admin.offers.index')); ?>">
                                    <div class="row">
                                        <div class="col-xs-4">
                                                ...
                                                <label>Категория:
                                                    <select name="f[id_category]" id="form-field-20">
                                                        ...
                                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <?php echo $__env->make('admin.offers.dropdown', ['cats' => $category->children, 'index' => 1], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                                            <?php endif; ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-3">
                                            <div>
                                                <a class="btn  btn-xs" href="<?php echo e(route('admin.offers.index')); ?>?refresh=1">
                                                    Сбросить
                            ...
                            <table id="simple-table" class="table table-striped table-bordered table-hover">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $offers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr <?php if($item->trashed()): ?>style="background-color: #F6CECE"<?php endif; ?>>
                                        <td>
                                            <?php if($item->image): ?>
                                                <a data-rel="colorbox" href="<?php echo e($item->uploads->image->url()); ?>">
                                                    <img src="<?php echo e($item->uploads->image->preview->url()); ?>" width="231" />
                                                </a>
                                            <?php endif; ?>
                                        </td>
                                        ...
                                        <td>
                                            <div class="hidden-sm hidden-xs btn-group">
                                                <?php if($item->trashed()): ?>
                                                <form method="POST" action='<?php echo e(route('admin.offers.restore', $item->id)); ?>' style="display:inline;">
                                                ...
                                                <?php else: ?>
                                                <a class="btn btn-xs btn-info" href="<?php echo e(route('admin.offers.edit', $item->id)); ?>">
                                                    <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                </a>
                                                <form method="POST" action='<?php echo e(route('admin.offers.destroy', $item->id)); ?>' style="display:inline;">

    ...
    <div class="container">
            ...
            {{--<div class="look-dropdown">--}}
                {{--<div class="look-dropdown__text">--}}
                    ...
                    {{--<div class="look-dropdown__body">--}}
                        ...
                        {{--<a class="btn btn_orange" href="{{ route('catalog', ['sysname' => $category1->sysname]) }}">Подобрать</a>--}}
                    {{--</div>--}}
                {{--</div>--}}
                {{--<a class="look-dropdown__image" href="{{ route('catalog', ['sysname' => $category1->sysname]) }}">--}}
            ...
            {{--<div class="look-dropdown">--}}
                {{--<div class="look-dropdown__text-gray">--}}
                    ...
                    {{--<div class="look-dropdown__body-white">--}}
                        ...
                        {{--<a class="btn btn_orange" href="{{ route('catalog', ['sysname' => $category2->sysname]) }}">Подобрать</a>--}}
                    {{--</div>--}}
                {{--</div>--}}
                {{--<a class="look-dropdown__image" href="{{ route('catalog', ['sysname' => $category2->sysname]) }}">--}}
        ...
        {{--<div class="catalog-dropdown__item catalog-dropdown__item_training js-training js-training-desktop js-catalog">--}}
            ...
            {{--<div class="catalog-dropdown__categories container js-dropdown-training">--}}
                {{--@include('widgets.catalog_categories', ['category' => $category3, 'chunk' => 8])--}}
            {{--</div>--}}

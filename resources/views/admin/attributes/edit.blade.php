        ...
        <div class="row">
            <div class="col-xs-12 ace-thumbnails">
                ...
                <form class="form-horizontal" role="form" action="{{route('admin.attributes.update', $attribute->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group div-type-data div-integer" id="div-integer" @if((old() && old('type') != 'integer') || (!old() && $attribute->type!='Числовой')) style="display:none" @endif>
                    ...
                    <div class="form-group div-type-data div-list div-checklist" id="div-list" @if((old() && old('type') != 'list') || (!old() && !in_array($attribute->type, ['Список', 'Список чекбоксов']) )) style="display:none" @endif>

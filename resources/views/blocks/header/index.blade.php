        ...
        <div class="header">
            ...
            <div class="header__phones">
                {{--<div>--}}
                    ...
                    {{--&nbsp;--}}
                {{--</div>--}}
                <div class="header__item"><i class="sprite sprite-phone-icon-min"></i>{!! $global_settings['phone_number']->value['msk'] !!}<br/>
                    <span>с {{ $global_settings['schedule']->value['start_workday'] }} до {{ $global_settings['schedule']->value['end_workday'] }} без выходных</span>
                </div>
                <div class="header__item"><i class="sprite sprite-phone-icon-min"></i>{!! $global_settings['phone_number']->value['free'] !!}<br/><span>Бесплатно по России</span>
                </div>
            </div>

...
@if(isset($quick_buy) && $quick_buy === 1)
    На сайте <a href="{{Request::root()}}"><b>belberg</b>></a> произведен быстрый заказ <b>№ {{$order->id}}</b>:
@else
    На сайте <a href="{{Request::root()}}"><b>belberg</b></a> произведен заказ <b>№ {{$order->id}}</b>:
@endif
<br>
